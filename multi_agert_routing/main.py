...
from autogen import planning_agent,database_search_agent,graph_agent,model_client,selector_prompt,termination,summarizer_agent
...
async def get_team(
    ...
    team = SelectorGroupChat(
        [planning_agent, database_search_agent,graph_agent,summarizer_agent,user_proxy],
...
async def ask_question(request):
    ...
    # )
    team = SelectorGroupChat(
        [planning_agent, database_search_agent,graph_agent,summarizer_agent],
        model_client=model_client,
        termination_condition=termination,
        selector_prompt=selector_prompt,
        allow_repeated_speaker=False,  # Allow an agent to speak multiple turns in a row.
